...
The wiki lives at `<workspace>/wiki/`. `raw/` (immutable ingested sources) and `work/` (unified work tracker) are siblings of `wiki/`, owned by `lattice-workspace` — not by this agent.
