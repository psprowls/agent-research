...
# GRAPH_WIKI_USERGATE_GUARD env convention. Comma-separated literal tokens.
_extra_kw = os.environ.get("GRAPH_WIKI_USERGATE_KEYWORDS", "").strip()
if _extra_kw:
...
# GRAPH_WIKI_USERGATE_KEYWORDS extension carry the false-positive fix instead.
