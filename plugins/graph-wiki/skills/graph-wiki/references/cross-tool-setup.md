...
python ${CLAUDE_PLUGIN_ROOT}/skills/graph-wiki/scripts/scan_monorepo.py --json
python ${CLAUDE_PLUGIN_ROOT}/skills/graph-wiki/scripts/lint_wiki.py
```

Handy aliases:

```bash
alias graph-wiki-scan='python ${CLAUDE_PLUGIN_ROOT}/skills/graph-wiki/scripts/scan_monorepo.py'
alias graph-wiki-lint='python ${CLAUDE_PLUGIN_ROOT}/skills/graph-wiki/scripts/lint_wiki.py'
alias llm-code-search='python ${CLAUDE_PLUGIN_ROOT}/skills/graph-wiki/scripts/wiki_search.py'
```
