...
- `detect_containers.detect(repo)` — heuristic container detection (agents/, packages/, etc.)
...
- `detect_containers.py` — heuristic detection of `apps/`, `packages/`, `agents/` containers from repo structure
