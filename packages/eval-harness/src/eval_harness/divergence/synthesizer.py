...
def _check_citation_present(output: AgentOutputProxy, wiki: Path) -> Verdict:
    ...
    Anchors agents/graph-wiki-agent/src/graph_wiki_agent/prompts/sources/synthesizer.md#rules (rule 1 + 3).
    """
...
def _check_no_slug_only_wikilinks(output: AgentOutputProxy, wiki: Path) -> Verdict:
    ...
    Anchors agents/graph-wiki-agent/src/graph_wiki_agent/prompts/sources/synthesizer.md#rules (rule 2).
    """
...
def _check_vault_thin_acknowledgement(
    ...
    Anchors agents/graph-wiki-agent/src/graph_wiki_agent/prompts/sources/synthesizer.md#rules (rule 4).
    """
    text = output.answer or ""
...
SYNTHESIZER_CHECKS: list[DivergenceCheck] = [
    DivergenceCheck(
        ...
        source_anchor="agents/graph-wiki-agent/src/graph_wiki_agent/prompts/sources/synthesizer.md#rules",
        severity="hard",
    ...
    DivergenceCheck(
        ...
        source_anchor="agents/graph-wiki-agent/src/graph_wiki_agent/prompts/sources/synthesizer.md#red-flags",
        severity="hard",
