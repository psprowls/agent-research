...
def test_lib001_passes_when_no_wikilinks(fixture_vault_path: Path) -> None:
...
def test_lib002_passes_with_wikilink(fixture_vault_path: Path) -> None:
...
def test_lib002_passes_with_backtick_code_path(fixture_vault_path: Path) -> None:
...
def test_lib002_fails_on_no_citation(fixture_vault_path: Path) -> None:
...
def test_lib003_passes_with_path_wikilink(fixture_vault_path: Path) -> None:
...
def test_lib003_fails_on_slug_only_wikilink(fixture_vault_path: Path) -> None:
...
def test_lib004_passes_when_no_bare_paths(fixture_vault_path: Path) -> None:
...
def test_lib004_fails_on_bare_code_path(fixture_vault_path: Path) -> None:
...
def test_ing001_passes_with_frontmatter(fixture_vault_path: Path) -> None:
...
def test_ing001_fails_without_frontmatter(fixture_vault_path: Path) -> None:
...
def test_ing001_fails_missing_closing_delimiter(fixture_vault_path: Path) -> None:
...
def test_ing002_passes_with_all_required_fields(fixture_vault_path: Path) -> None:
...
def test_ing002_fails_missing_target_slug(fixture_vault_path: Path) -> None:
...
def test_ing002_fails_missing_multiple_fields(fixture_vault_path: Path) -> None:
...
def test_ing003_passes_with_valid_page_type(fixture_vault_path: Path) -> None:
...
def test_ing003_fails_with_invalid_page_type(fixture_vault_path: Path) -> None:
...
def test_ing004_passes_source_with_source_category(fixture_vault_path: Path) -> None:
...
def test_ing004_fails_source_page_type_with_wrong_category(fixture_vault_path: Path) -> None:
...
def test_ing004_fails_package_page_type_with_concept_category(fixture_vault_path: Path) -> None:
...
def test_lnt001_passes_code_drift_before_orphan(fixture_vault_path: Path) -> None:
...
def test_lnt001_fails_orphan_before_code_drift(fixture_vault_path: Path) -> None:
...
def test_lnt001_passes_no_findings_of_either_type(fixture_vault_path: Path) -> None:
...
def test_lnt002_passes_with_nonempty_findings(fixture_vault_path: Path) -> None:
...
def test_lnt002_fails_on_empty_output(fixture_vault_path: Path) -> None:
    """LNT-002 fails when linter output is empty (or only whitespace)."""
    check = _get_check(LINTER_CHECKS, "LNT-002-findings-nonempty-when-issues")
    for empty in ("", "   ", "\n\n\t"):
        verdict = check.check(AgentOutputProxy(answer=empty), fixture_vault_path)
...
def test_lnt003_passes_on_report_only_output(fixture_vault_path: Path) -> None:
...
def test_lnt003_fails_on_write_operation_in_output(fixture_vault_path: Path) -> None:
...
def test_lnt003_fails_on_created_verb(fixture_vault_path: Path) -> None:
...
def test_scn001_passes_with_frontmatter(fixture_vault_path: Path) -> None:
    ...
    verdict = check.check(AgentOutputProxy(answer=_FULL_SCANNER_OUTPUT), fixture_vault_path)
    assert verdict.passed is True


def test_scn001_fails_without_frontmatter(fixture_vault_path: Path) -> None:
...
def test_scn002_passes_with_all_required_fields(fixture_vault_path: Path) -> None:
...
def test_scn002_fails_missing_language_field(fixture_vault_path: Path) -> None:
...
def test_scn003_passes_without_file_map_section(fixture_vault_path: Path) -> None:
...
def test_scn003_fails_with_file_map_section(fixture_vault_path: Path) -> None:
...
def test_scn004_passes_with_overview_section(fixture_vault_path: Path) -> None:
...
def test_scn004_fails_without_overview_section(fixture_vault_path: Path) -> None:
