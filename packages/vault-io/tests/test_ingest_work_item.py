...
"""Tests for vault_io.ingest_work_item — ported from lattice-wiki-core.
...
def test_slugify_basic() -> None:
    from vault_io.ingest_work_item import _slugify
...
def test_parse_frontmatter_scalar_fields() -> None:
    from vault_io.ingest_work_item import _parse_frontmatter
...
def test_validate_returns_empty_for_valid_fm() -> None:
    from vault_io.ingest_work_item import _parse_frontmatter, _validate
...
def test_validate_catches_missing_required_fields() -> None:
    from vault_io.ingest_work_item import _validate
...
def test_emit_yaml_roundtrip() -> None:
    from vault_io.ingest_work_item import _emit_yaml, _parse_frontmatter
...
def test_file_work_item_creates_page(tmp_path: Path) -> None:
    from vault_io.ingest_work_item import _parse_frontmatter, file_work_item
    ...
    with (
        patch("vault_io.ingest_work_item.update_index") as mock_ui,
        patch("vault_io.ingest_work_item.append_log") as mock_al,
    ):
...
def test_file_work_item_slug_from_title(tmp_path: Path) -> None:
    ...
    with (
        patch("vault_io.ingest_work_item.update_index"),
        patch("vault_io.ingest_work_item.append_log"),
    ):
        result = file_work_item(wiki, fm, body)
...
def test_no_subprocess_or_lattice_imports() -> None:
    ...
    spec = importlib.util.find_spec("vault_io.ingest_work_item")
