...
1. `cg --fmt json status` exit code 2 = stale — see ADR-0002-explicit-graph-update-lifecycle and `packages/lattice-graph-core/src/lattice_graph_core/exit_codes.py`.
