"""Unit tests for vault_io.init_vault._resolve_pinned_containers — workspace exclusion plumb-through.
...
def test_resolve_pinned_containers_v2_excludes_workspace(tmp_path: Path) -> None:
    ...
    from vault_io.init_vault import _resolve_pinned_containers
