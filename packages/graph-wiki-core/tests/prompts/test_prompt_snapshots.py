...
def test_ingestor_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.ingestor import INGESTOR_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
...
def test_linter_page_quality_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.linter import LINTER_PAGE_QUALITY_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
...
def test_linter_adr_chain_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.linter import LINTER_ADR_CHAIN_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
...
def test_linter_stale_claims_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.linter import LINTER_STALE_CLAIMS_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
...
def test_scanner_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.scanner import SCANNER_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
...
def test_code_reader_system_snapshot(snapshot: SnapshotAssertion) -> None:
    ...
    try:
        from graph_wiki_core.prompts.code_reader import CODE_READER_SYSTEM
    except ImportError:
        pytest.skip("prompts module not yet implemented")
