...
#   git show e9cfd56:agents/graph-wiki-core/src/graph_wiki_core/prompts/scanner.py > /tmp/old_scanner.py
#   git show e9cfd56:agents/graph-wiki-core/src/graph_wiki_core/prompts/ingestor.py > /tmp/old_ingestor.py
#   git show e9cfd56:agents/graph-wiki-core/src/graph_wiki_core/prompts/linter.py > /tmp/old_linter.py
#   git show e9cfd56:agents/graph-wiki-core/src/graph_wiki_core/prompts/librarian.py > /tmp/old_librarian.py
#   uv run python -c "
...
# and HEAD — `git diff e9cfd56 HEAD -- agents/graph-wiki-core/src/graph_wiki_core/prompts/_fragments/`
...
def test_librarian_token_budget() -> None:
    try:
        from graph_wiki_core.prompts.librarian import build_librarian_system
    except ImportError:
        pytest.skip("prompts module not yet implemented")
