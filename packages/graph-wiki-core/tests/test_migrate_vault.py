"""Phase 46 Plan 03: CLI + integration tests for ``graph-wiki-core migrate-vault``."""
...
from graph_wiki_core.commands.migrate_vault import (
...
def test_migrate_vault_aborts_before_commit_on_failure(vault, monkeypatch):
    ...
    from graph_wiki_core.commands import migrate_vault as mv_module
