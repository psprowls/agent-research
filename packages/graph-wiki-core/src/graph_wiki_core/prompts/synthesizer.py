...
2. **Supporting detail** — organized thematically, weaving in inline citations: `[[entities/...]]` wikilinks for vault pages and `` `path:line` `` backtick-wrapped references for code locations.
