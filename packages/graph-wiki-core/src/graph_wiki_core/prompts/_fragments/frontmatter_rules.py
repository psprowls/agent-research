...
- `source_type`: closed-enum classification (`spec`, `article`, `pr`, `ticket`, `transcript`, `example`, `doc`, `note`); does NOT control routing — every ingested doc lands under `sources/`
