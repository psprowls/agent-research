...
|---|---|---|---|---|---|---|
| tailwindcss | package | npm | tailwind | 3.4.0 | web-next-ts | `[[tailwind]]` |
| autoprefixer | package | npm | *(tailwind co-req)* | 10.4.16 | web-next-ts | — |
| MongoDB Atlas | service | mongodb-atlas | — | n/a | location-aws-node-ts | `[[mongodb-atlas]]` |
...
4. Wikilinks to deleted stub pages either rewrite to `[[dependencies/index]]` or surface as broken-link audit entries.
