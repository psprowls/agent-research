...
- [[packages/nonexistent-package/nonexistent-package]] — no such package page
- [[concepts/also-missing]] — no such concept page
- [[adrs/9999-never-written]] — no such ADR

## Valid link

The following link points to a page that does exist:

- [[concepts/missing-title]] — this page exists (though it lacks a title field)
