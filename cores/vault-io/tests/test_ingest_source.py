...
"""Tests for vault_io.ingest_source — ported from lattice-wiki-core.
...
def test_slugify_simple() -> None:
    from vault_io.ingest_source import slugify
...
def test_extract_md_returns_text_and_heading_title(tmp_path: Path) -> None:
    from vault_io.ingest_source import extract
...
def test_guess_source_type_specs() -> None:
    from vault_io.ingest_source import guess_source_type
...
def test_language_for_python() -> None:
    from vault_io.ingest_source import language_for
...
def test_pick_representative_readme_wins(tmp_path: Path) -> None:
    from vault_io.ingest_source import pick_representative
...
def test_constants_present() -> None:
    import vault_io.ingest_source as m
...
def test_no_lattice_wiki_core_imports() -> None:
    ...
    spec = importlib.util.find_spec("vault_io.ingest_source")
