...
INGESTOR_CHECKS: list[DivergenceCheck] = [
    DivergenceCheck(
        ...
        source_anchor="cores/prompt-sources/agents/ingestor.md#workflow-step-4",
        severity="hard",
    ...
    DivergenceCheck(
        ...
        source_anchor="cores/prompt-sources/SKILL.md#page-categories",
        severity="hard",
        check=_check_page_type_routing,
    ),
    DivergenceCheck(
        id="ING-004-page-type-valid-category",
        source_anchor="cores/prompt-sources/agents/ingestor.md#rules",
        severity="hard",
