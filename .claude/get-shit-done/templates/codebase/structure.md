...
- Usage: Reference from command with `@/Users/pat/Personal/agent-research/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/pat/Personal/agent-research/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/pat/Personal/agent-research/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
