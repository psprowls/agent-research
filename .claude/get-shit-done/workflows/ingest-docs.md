...
```bash
INIT=$(node "/Users/pat/Personal/agent-research/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/pat/Personal/agent-research/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
