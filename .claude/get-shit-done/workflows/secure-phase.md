...
```
Agent(
  prompt="Read /Users/pat/Personal/agent-research/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/pat/Personal/agent-research/.claude/get-shit-done/templates/SECURITY.md`
