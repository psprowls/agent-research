...
```bash
INIT=$(node "/Users/pat/Personal/agent-research/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/pat/Personal/agent-research/.claude/get-shit-done/templates/spec.md.
