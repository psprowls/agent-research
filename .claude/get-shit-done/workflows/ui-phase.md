...
```markdown
Read /Users/pat/Personal/agent-research/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/pat/Personal/agent-research/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/pat/Personal/agent-research/.claude/agents/gsd-ui-checker.md for instructions.
