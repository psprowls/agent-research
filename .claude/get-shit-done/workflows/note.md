...
- **Global scope**: `/Users/pat/Personal/agent-research/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pat/Personal/agent-research/.claude/notes/`)
...
2. Glob `/Users/pat/Personal/agent-research/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pat/Personal/agent-research/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pat/Personal/agent-research/.claude/notes/` — works in any directory
