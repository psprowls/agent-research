...
- Preserve the existing fragment curation discipline — every shared prompt fragment under `agents/graph-wiki-agent/src/graph_wiki_agent/prompts/_fragments/` carries the standard `# Source:` / `# Anchor:` / `# Source-commit:` provenance header.
