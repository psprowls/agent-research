...
Reference full template: `/Users/pat/Personal/agent-research/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/pat/Personal/agent-research/.claude/get-shit-done/templates/state.md`.
