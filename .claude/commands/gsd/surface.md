...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/pat/Personal/agent-research/.claude/.gsd-surface.json`
(sibling to `/Users/pat/Personal/agent-research/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/pat/Personal/agent-research/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/pat/Personal/agent-research/.claude/skills`).
...
`/Users/pat/Personal/agent-research/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/pat/Personal/agent-research/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/pat/Personal/agent-research/.claude/.gsd-surface.json`
Install profile marker: `/Users/pat/Personal/agent-research/.claude/.gsd-profile`
Skill dirs: `/Users/pat/Personal/agent-research/.claude/skills/gsd-*/`
Engine module: `/Users/pat/Personal/agent-research/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/pat/Personal/agent-research/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
