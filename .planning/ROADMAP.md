...
**Plans**: 3 plans
  ...
  - [x] 50-02-PLAN.md — Wire classify() into packages.refresh emit loop + D-06 in-place UPDATE for cross-run kind flips
  - [x] 50-03-PLAN.md — Query layer (AppDescription, list_apps, describe_app), CLI handlers (cg list-apps, cg describe-app), end-to-end integration tests
**UI hint**: no
...
**Plans**: 4 plans
  ...
  - [x] 51-02-PLAN.md — wiki-io removal: ADMITTED_KINDS finalize + V18 alias delete, template assets delete, link_rewriter D-04 deferral cleanup, lint/dependency.py package-family removal
  - [x] 51-03-PLAN.md — eval-harness CLEANUP-01: delete LIB-003 (_SLUG_ONLY_RE, _check_no_slug_only_wikilinks, registry entry) + baseline regen
  - [x] 51-04-PLAN.md — round-trip fixture surgical edits + BM25-only vocab regen + phase exit gates G1/G2
**UI hint**: no
