...
<details>
<summary>✅ v1.10 Wiki Index & Entity Page Enrichment (Phases 54-59) — SHIPPED 2026-05-29</summary>

- [x] Phase 54: Debt Clearance (1/1 plan) — completed 2026-05-28
- [x] Phase 55: Dependency Classification Fix (2/2 plans) — completed 2026-05-28
- [x] Phase 56: Entity Templates & Scan-Time Population (4/4 plans) — completed 2026-05-28
- [x] Phase 57: Index Generation Polish (1/1 plan) — completed 2026-05-29
- [x] Phase 58: Entity Page & Index UAT Follow-Ups (3/3 plans) — completed 2026-05-29
- [x] Phase 59: Decouple graph-wiki-agent from `graph_io.cli` (3/3 plans) — completed 2026-05-29
...
| 61. TypeScript `type` Node Kind | v1.11 | 1/3 | In Progress|  |
